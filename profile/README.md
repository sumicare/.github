...
[Sumi.care](https://sumi.care/oss) OSS Projects
 ...
 - [teerpc-go](https://github.com/sumicare/teerpc-go) - internal [tRPC](https://trpc.io/) scaffold for Golang
 - [teerpc-rs](https://github.com/sumicare/teerpc-rs) - internal [tRPC](https://trpc.io/) scaffold for Rust

[OpenTofu](https://opentofu.org/) providers:
 - [provider-careplane](https://github.com/sumicare/opentofu-provider-careplane) - [Sumi.care](https://sumi.care) [Careplane](https://sumi.care/plane) provider
